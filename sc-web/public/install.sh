...
echo "  Next steps:"
echo ""
echo "  1. Sign in at https://sprite-cloud.com/signin"
echo "  2. Go to Dashboard → Generate Pairing Code"
echo "  3. Run:  sc-server pair <code> --sc-web-url https://sprite-cloud.com"
echo "  4. Set ROM directories and start:"
echo "       GV_ROM_ROOTS=/path/to/roms sc-server start"
echo ""
