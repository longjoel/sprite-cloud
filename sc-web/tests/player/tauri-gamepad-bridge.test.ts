...
import { ScPlayer } from "../../public/player/sc-player.js";

// ── Replicated bridge logic (from sc-tauri-bridge.js) ────────────────
...
// ── RetroPad mask constants (match sc-desktop main.rs) ────────────────
...
describe("tauri gamepad bridge — lifecycle with sc-player", () => {
  ...
  function harness(pads: Array<any>, baseSeat = 0) {
    ...
    const player: any = Object.create(ScPlayer.prototype);
