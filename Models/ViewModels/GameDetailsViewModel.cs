...
public sealed class GameDetailsViewModel
{
    ...
    public IReadOnlyList<games_vault.Models.GamePlayerFile> PlayerFiles { get; init; } = Array.Empty<games_vault.Models.GamePlayerFile>();
    ...
    public int PlayerFilePage { get; init; }
    public int PlayerFilePageSize { get; init; }
    public int PlayerFileTotalCount { get; init; }

    public int PlayerFilePageCount => PlayerFilePageSize <= 0 ? 0 : (int)Math.Ceiling(PlayerFileTotalCount / (double)PlayerFilePageSize);
    public bool PlayerFileHasPrevious => PlayerFilePage > 1;
    public bool PlayerFileHasNext => PlayerFilePage < PlayerFilePageCount;
}
